...
{"0": {
    ...
    "doc": "SERCOM USART interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_l10_xpro.X sam_l10_xpro_keil.KEIL | SAML10 Xplained Pro Evaluation Kit | . |   |   | . Setting up SAML10 Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "Systick periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and Program the application using its IDE | The LED blinks continuously | . Following table provides the LED name: . | Board | LED Name | . | SAML10 Xplained Pro Evaluation Kit | SW0 | . |   |   | . ",
