...
[SAML10 Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/dm320204)

| Timer Channel   | Pin      | Observable characteristic of the waveform
| ----------------| ---------| -----------------------------------------|
| TC0_WO1 | PA05(Pin 15 of EXT1) | Active high output with 50 Hz frequency |
| TC2_WO0 | PA18(Pin 7 of EXT1)  | Toggle output with 25 Hz frequency |
| TC1_WO1 | PA25 (Pin 13 of EXT2) | Active low output with 50 Hz frequency|
||||
